...
enum HJTiming: Int {
    ...
    var tint: Color {
        switch self {
        case .fixedHijri: return HJTheme.indigo
        case .sightingLed: return HJTheme.gold
        case .recurring: return HJTheme.verdant
        }
    }
}

/// What fasting looks like on the day, kept deliberately plain.
enum HJFastingStance: Int {
    case none = 0
    case voluntary = 1
    case obligatory = 2
    case notPermitted = 3
    ...
    var tint: Color {
        switch self {
        case .notPermitted, .discouraged: return HJTheme.clay
        case .obligatory: return HJTheme.ink
        case .voluntary: return HJTheme.verdant
        case .none: return HJTheme.inkFaint
        }
    }
}

enum HJObservanceGroup: Int, CaseIterable {
    case landmark = 0
    case ramadan = 1
    case hajj = 2
    case fasting = 3
...
struct HJObservance: Identifiable {
    let id: String
    let name: String
    ...
    let span: Int
    let timing: HJTiming
    let group: HJObservanceGroup
    let fasting: HJFastingStance
    ...
    init(_ id: String,
         ...
         span: Int = 1,
         timing: HJTiming,
         group: HJObservanceGroup,
         fasting: HJFastingStance = .none,
         dateNote: String,
         summary: String,
         marksGrid: Bool = true) {
        self.id = id
...
enum HJObservances {
    ...
    static let all: [HJObservance] = [

        // ------------------------------------------------------------- Muharram
        HJObservance("newyear", "Islamic New Year",
                     month: 1, day: 1,
        ...
        HJObservance("tasua", "The Day of Tasu'a",
                     month: 1, day: 9,
        ...
        HJObservance("ashura", "The Day of Ashura",
                     month: 1, day: 10,
                     timing: .sightingLed, group: .landmark,
                     fasting: .voluntary,
        ...
        HJObservance("muharram-month", "Muharram, a sacred month",
        ...
        // ------------------------------------------------------------- Rabi al-Awwal
        HJObservance("mawlid", "Mawlid an-Nabi",
                     month: 3, day: 12,
        ...
        // ------------------------------------------------------------- Rajab
        HJObservance("rajab-month", "Rajab, a sacred month",
        ...
        HJObservance("isra", "Isra and Mi'raj",
                     month: 7, day: 27,
                     timing: .fixedHijri, group: .landmark,
                     dateNote: "27 Rajab",
        ...
        // ------------------------------------------------------------- Sha'ban
        HJObservance("midshaban", "Mid-Sha'ban",
                     month: 8, day: 15,
                     timing: .fixedHijri, group: .landmark,
                     dateNote: "15 Sha'ban",
        ...
        HJObservance("shaban-fast", "Fasting in Sha'ban",
        ...
        HJObservance("doubt", "The Day of Doubt",
                     month: 8, day: 0,
        ...
        // ------------------------------------------------------------- Ramadan
        HJObservance("ramadan-start", "The first day of Ramadan",
                     month: 9, day: 1,
        ...
        HJObservance("ramadan-month", "Ramadan, the month of fasting",
        ...
        HJObservance("lastten", "The last ten nights",
        ...
        HJObservance("qadr-window", "The Laylat al-Qadr window",
        ...
        HJObservance("qadr-27", "The twenty-seventh night",
                     month: 9, day: 27,
                     timing: .sightingLed, group: .ramadan,
                     dateNote: "27 Ramadan",
        ...
        HJObservance("fitr-zakat", "Zakat al-Fitr",
        ...
        // ------------------------------------------------------------- Shawwal
        HJObservance("eid-fitr", "Eid al-Fitr",
                     month: 10, day: 1,
                     timing: .sightingLed, group: .landmark,
        ...
        HJObservance("shawwal-six", "The six days of Shawwal",
        ...
        // ------------------------------------------------------------- Dhu al-Qadah
        HJObservance("qadah-month", "Dhu al-Qadah, a sacred month",
        ...
        // ------------------------------------------------------------- Dhu al-Hijjah
        HJObservance("hijjah-month", "Dhu al-Hijjah, a sacred month",
        ...
        HJObservance("first-ten", "The first ten days of Dhu al-Hijjah",
        ...
        HJObservance("tarwiyah", "The Day of Tarwiyah",
                     month: 12, day: 8,
                     timing: .sightingLed, group: .hajj,
                     fasting: .voluntary,
        ...
        HJObservance("arafah", "The Day of Arafah",
                     month: 12, day: 9,
                     timing: .sightingLed, group: .hajj,
                     fasting: .voluntary,
        ...
        HJObservance("eid-adha", "Eid al-Adha",
                     month: 12, day: 10,
                     timing: .sightingLed, group: .landmark,
                     fasting: .notPermitted,
        ...
        HJObservance("tashriq", "The Days of Tashriq",
        ...
        HJObservance("hajj-season", "The days of Hajj",
        ...
        // ------------------------------------------------------------- Recurring
        HJObservance("white-days", "The white days",
        ...
        HJObservance("mon-thu", "Mondays and Thursdays",
                     month: 0, day: 0,
                     timing: .recurring, group: .fasting,
                     fasting: .voluntary,
        ...
        HJObservance("jumuah", "Jumu'ah, the Friday gathering",
                     month: 0, day: 0,
        ...
        HJObservance("ayyam-bid-note", "The white days in Dhu al-Hijjah",
        ...
        // ------------------------------------------------------------- Restricted
        HJObservance("no-fast-fitr", "Fasting is not permitted on Eid al-Fitr",
                     month: 10, day: 1,
                     timing: .sightingLed, group: .restricted,
                     fasting: .notPermitted,
                     dateNote: "1 Shawwal",
        ...
        HJObservance("no-fast-adha", "Fasting is not permitted on Eid al-Adha",
                     month: 12, day: 10,
                     timing: .sightingLed, group: .restricted,
                     fasting: .notPermitted,
                     dateNote: "10 Dhu al-Hijjah",
        ...
        HJObservance("no-fast-tashriq", "Fasting is not permitted on the Days of Tashriq",
                     month: 12, day: 11, span: 3,
                     timing: .sightingLed, group: .restricted,
                     fasting: .notPermitted,
                     dateNote: "11 to 13 Dhu al-Hijjah",
        ...
        HJObservance("no-fast-friday", "Singling out Friday for a fast",
                     month: 0, day: 0,
        ...
        HJObservance("no-fast-saturday", "Singling out Saturday for a fast",
                     month: 0, day: 0,
                     timing: .recurring, group: .restricted,
                     fasting: .discouraged,
        ...
        HJObservance("no-fast-perpetual", "Fasting every day without a break",
                     month: 0, day: 0,
                     timing: .recurring, group: .restricted,
                     fasting: .discouraged,
        ...
        // ------------------------------------------------------------- Sacred months
        HJObservance("four-sacred", "The four sacred months",
                     month: 0, day: 0,
        ...
        HJObservance("no-intercalation", "Why the months drift",
                     month: 0, day: 0,
                     timing: .recurring, group: .sacredMonths,
                     dateNote: "Every year",
    ...
    static func byGroup(_ group: HJObservanceGroup) -> [HJObservance] {
        all.filter { $0.group == group }
    }

    /// Entries that occupy the given Hijri day, for the grid marker and the day sheet.
    static func marking(_ date: HJHijriDate) -> [HJObservance] {
        all.filter { entry in
    ...
    static func touching(_ date: HJHijriDate) -> [HJObservance] {
        all.filter { entry in
    ...
    static func upcoming(fromJDN: Int, store: HJStore, limit: Int) -> [(observance: HJObservance, jdn: Int)] {
        let today = store.hijri(forJDN: fromJDN)
        var out: [(HJObservance, Int)] = []
        for entry in all where entry.isDated && entry.marksGrid {
            ...
            for _ in 0...1 {
                ...
                let jdn = store.jdn(forHijri: HJHijriDate(year: year, month: month, day: day))
