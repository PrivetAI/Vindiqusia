...
struct HJHistoryEvent: Identifiable {
    let id: String
    let title: String
...
enum HJHistoryLibrary {
    ...
    static let events: [HJHistoryEvent] = [

        // --------------------------------------------------- before the Hijra
        HJHistoryEvent("elephant", "The Year of the Elephant",
        ...
        HJHistoryEvent("first-revelation", "The first revelation",
        ...
        HJHistoryEvent("abyssinia", "The migration to Abyssinia",
        ...
        HJHistoryEvent("year-sorrow", "The Year of Sorrow",
        ...
        // --------------------------------------------------- 1st century AH
        HJHistoryEvent("hijra", "The Hijra to Medina",
        ...
        HJHistoryEvent("constitution", "The Constitution of Medina",
        ...
        HJHistoryEvent("qibla", "The change of the qibla",
        ...
        HJHistoryEvent("ramadan-obligatory", "Fasting in Ramadan made obligatory",
                       ah: 2, ahLabel: "2 AH", ce: "624 CE",
        ...
        HJHistoryEvent("badr", "The Battle of Badr",
        ...
        HJHistoryEvent("uhud", "The Battle of Uhud",
        ...
        HJHistoryEvent("trench", "The Battle of the Trench",
        ...
        HJHistoryEvent("hudaybiyyah", "The Treaty of Hudaybiyyah",
        ...
        HJHistoryEvent("khaybar", "The taking of Khaybar",
        ...
        HJHistoryEvent("mutah", "The Battle of Mu'ta",
        ...
        HJHistoryEvent("mecca", "The conquest of Mecca",
        ...
        HJHistoryEvent("hunayn", "The Battle of Hunayn",
        ...
        HJHistoryEvent("tabuk", "The expedition to Tabuk",
        ...
        HJHistoryEvent("farewell", "The Farewell Pilgrimage",
        ...
        HJHistoryEvent("prophet-death", "The death of the Prophet",
        ...
        HJHistoryEvent("abubakr", "Abu Bakr becomes caliph",
        ...
        HJHistoryEvent("ridda", "The Ridda wars",
        ...
        HJHistoryEvent("umar", "Umar becomes caliph",
        ...
        HJHistoryEvent("yarmuk", "The Battle of Yarmuk",
        ...
        HJHistoryEvent("qadisiyyah", "The Battle of al-Qadisiyyah",
        ...
        HJHistoryEvent("jerusalem", "Jerusalem enters Muslim rule",
        ...
        HJHistoryEvent("calendar", "The Hijri calendar instituted",
        ...
        HJHistoryEvent("nahavand", "The Battle of Nahavand",
        ...
        HJHistoryEvent("uthman", "Uthman becomes caliph",
        ...
        HJHistoryEvent("mushaf", "The standard codex of the Quran",
        ...
        HJHistoryEvent("ali", "Ali becomes caliph",
        ...
        HJHistoryEvent("camel", "The Battle of the Camel",
        ...
        HJHistoryEvent("siffin", "The Battle of Siffin",
        ...
        HJHistoryEvent("nahrawan", "The Battle of Nahrawan",
        ...
        HJHistoryEvent("ali-death", "The death of Ali",
        ...
        HJHistoryEvent("umayyad", "The Umayyad caliphate begins",
        ...
        HJHistoryEvent("karbala", "Karbala",
        ...
        HJHistoryEvent("abdalmalik", "Abd al-Malik and the second civil war",
        ...
        HJHistoryEvent("dome", "The Dome of the Rock completed",
        ...
        HJHistoryEvent("coinage", "Arabic coinage and administration",
        ...
        HJHistoryEvent("iberia", "The crossing into Iberia",
        ...
        HJHistoryEvent("sind", "Expansion into Sind and Transoxiana",
        ...
        // --------------------------------------------------- 2nd century AH
        HJHistoryEvent("umar2", "The caliphate of Umar ibn Abd al-Aziz",
        ...
        HJHistoryEvent("tours", "The advance into Gaul halted",
        ...
        HJHistoryEvent("abbasid", "The Abbasid revolution",
        ...
        HJHistoryEvent("cordoba", "The emirate of Cordoba",
        ...
        HJHistoryEvent("baghdad", "Baghdad founded",
        ...
        HJHistoryEvent("abuhanifa", "Death of Abu Hanifa",
        ...
        HJHistoryEvent("malik", "Death of Malik ibn Anas",
        ...
        HJHistoryEvent("harun", "The caliphate of Harun al-Rashid",
        ...
        HJHistoryEvent("translation", "The translation movement",
        ...
        // --------------------------------------------------- 3rd century AH
        HJHistoryEvent("shafii", "Death of al-Shafi'i",
        ...
        HJHistoryEvent("khwarizmi", "Al-Khwarizmi",
        ...
        HJHistoryEvent("ibnhanbal", "Death of Ahmad ibn Hanbal",
        ...
        HJHistoryEvent("bukhari", "Death of al-Bukhari",
        ...
        HJHistoryEvent("muslim", "Death of Muslim ibn al-Hajjaj",
        ...
        // --------------------------------------------------- 4th century AH
        HJHistoryEvent("fatimid", "The Fatimid caliphate founded",
        ...
        HJHistoryEvent("tabari", "Death of al-Tabari",
        ...
        HJHistoryEvent("azhar", "Al-Azhar founded in Cairo",
        ...
        // --------------------------------------------------- 5th century AH
        HJHistoryEvent("ibnsina", "Death of Ibn Sina",
        ...
        HJHistoryEvent("manzikert", "The Battle of Manzikert",
        ...
        HJHistoryEvent("crusade", "The First Crusade takes Jerusalem",
        ...
        HJHistoryEvent("ghazali", "Death of al-Ghazali",
        ...
        HJHistoryEvent("hattin", "Salah al-Din retakes Jerusalem",
        ...
        HJHistoryEvent("ibnrushd", "Death of Ibn Rushd",
        ...
        HJHistoryEvent("baghdad-fall", "The Mongols sack Baghdad",
        ...
        HJHistoryEvent("aynjalut", "The Battle of Ayn Jalut",
        ...
        HJHistoryEvent("ibnbattuta", "Ibn Battuta sets out",
        ...
        HJHistoryEvent("muqaddimah", "Ibn Khaldun completes the Muqaddimah",
        ...
        HJHistoryEvent("constantinople", "The fall of Constantinople",
        ...
        HJHistoryEvent("granada", "The fall of Granada",
        ...
        HJHistoryEvent("cairo1517", "The Ottomans take Cairo",
    ...
    static func centuryLabel(_ century: Int) -> String {
        ...
        return "\(HJFormatter.ordinal(century)) century AH"
    }

    static func events(inCentury century: Int) -> [HJHistoryEvent] {
        events.filter { $0.century == century }
    }

    static var sortedEvents: [HJHistoryEvent] {
