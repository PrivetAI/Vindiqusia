...
struct VQMonthPage: Identifiable {
    var id: Int { number }
    let number: Int
...
enum VQMonthLibrary {
    ...
    static let pages: [VQMonthPage] = [

        VQMonthPage(number: 1,
    ...
    static func page(_ number: Int) -> VQMonthPage {
